...
@endsection
@section('content')
<h3 >Проект - тестовое задание компании Река</h3>
<hr class="mb-5">
<p>Для реализации использовать на бекенде PHP, фреймворк - Laravel, на фронте JS / jQuery. Для элементов интерфейса - Bootstrap
...
2) Разграничение прав доступа к списку (пользователь А может только читать, пользователь Б может читать и редактировать)</p>
@endsection
@section('aside')
@parent
